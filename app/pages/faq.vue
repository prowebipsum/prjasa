<template>
  <div>
    <ElementHero :title="faq?.title" :description="faq?.acf?.sub_title" :background="faq?.featured_image" />
    ...
    <div class="container mt-16">
        ...
        <div class="accordion divide-y divide-gray-200 border border-gray-300 rounded-xl bg-white">
          <div v-for="(item, index) in faq?.acf?.layanan_primajasa" :key="index" class="accordion-item">
            ...
            <button
              ...
              <icon name="material-symbols:expand-more-rounded" class="transition-transform duration-300 text-xl"
                :class="{ 'rotate-180': active === item.tanya }" />
            </button>

            <!-- Content -->
            <transition name="accordion">
              <div v-if="active === item.tanya" class="accordion-content px-4 pb-4 text-base text-gray-700"
                v-html="item.jawab" />
            </transition>
          </div>
        </div>
      ...
      <div class="acc mb-10">
        ...
        <div class="accordion divide-y divide-gray-200 border border-gray-300 rounded-xl bg-white">
          <div v-for="(item, index) in faq?.acf?.bis_reguler" :key="index" class="accordion-item">
            <!-- Title -->
            <button
              class="accordion-title flex w-full  justify-between px-4 py-3 text-left text-lg font-semibold cursor-pointer"
              @click="toggle(item.tanya)">
      ...
      <div class="acc mb-10">
        ...
        <div class="accordion divide-y divide-gray-200 border border-gray-300 rounded-xl bg-white">
          <div v-for="(item, index) in faq?.acf?.bis_moda" :key="index" class="accordion-item">
            <!-- Title -->
            <button
              class="accordion-title flex w-full  justify-between px-4 py-3 text-left text-lg font-semibold cursor-pointer"
              @click="toggle(item.tanya)">
      ...
      <div class="acc mb-10">
        ...
        <div class="accordion divide-y divide-gray-200 border border-gray-300 rounded-xl bg-white">
          <div v-for="(item, index) in faq?.acf?.shuttle" :key="index" class="accordion-item">
            <!-- Title -->
            <button
              class="accordion-title flex w-full  justify-between px-4 py-3 text-left text-lg font-semibold cursor-pointer"
              @click="toggle(item.tanya)">
      ...
      <div class="acc mb-10">
        ...
        <div class="accordion divide-y divide-gray-200 border border-gray-300 rounded-xl bg-white">
          <div v-for="(item, index) in faq?.acf?.bis_pariwisata" :key="index" class="accordion-item">
            <!-- Title -->
            <button
              class="accordion-title flex w-full  justify-between px-4 py-3 text-left text-lg font-semibold cursor-pointer"
              @click="toggle(item.tanya)">
