      ...
      <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-10">
          ...
          <div class="flex flex-col gap-4">
            ...
            <div>
              <p class="text-primary textlbase mb-2">{{ $t('footer.connect') }}</p>
              <p class="flex gap-4 items-center group">
                <icon name="bi:instagram" class="text-xl text-primary hover:text-red-300 duration-150" />
                <icon name="bi:facebook" class="text-xl text-primary hover:text-red-300 duration-150" />
                <icon name="bi:youtube" class="text-xl text-primary hover:text-red-300 duration-150" />
                <icon name="bi:linkedin" class="text-xl text-primary hover:text-red-300 duration-150" />
              </p>
            </div>
          </div>
          ...
          <div class="flex flex-col gap-4">
            <div>
              <h5 class="text-primary mb-1">{{ $t('footer.product') }}</h5>
              <ul class="menu">
          ...
          <div class="flex flex-col gap-4">
            <div>
              <h5 class="text-primary mb-1">{{ $t('footer.link') }}</h5>
              <ul class="menu">
                <li><nuxt-link :to="localPath('/about/profil-perusahaan')">{{ $t('footer.about') }}</nuxt-link></li>
                <li><nuxt-link :to="localPath('/promo')">{{ $t('footer.promo') }}</nuxt-link></li>
                <li><nuxt-link :to="localPath('/news')">{{ $t('footer.news') }}</nuxt-link></li>
                <li><nuxt-link :to="localPath('/blog')">{{ $t('footer.blog') }}</nuxt-link></li>
                <li><nuxt-link :to="localPath('/faq')">{{ $t('footer.faq') }}</nuxt-link></li>
                <li><nuxt-link :to="localPath('/karir')">{{ $t('footer.career') }}</nuxt-link></li>
                <li><nuxt-link :to="localPath('/kontak')">{{ $t('footer.contactPage') }}</nuxt-link></li>
              </ul>
            </div>
          </div>
